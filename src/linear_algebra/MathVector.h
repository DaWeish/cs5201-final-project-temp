 ...
 * author Connor Walsh
 * file   MathVector.h
 * brief  This class represents a vector which can have mathematical operations
 *        performed on it
 */
...
class MathVector
{
  ...
  public:
    ...
    * pre     Size should be positive otherwise the unsigned type will make a 
    *         negative into a positive number and results will be unexpected
    ...
    * post    other is now swapped with this therefore this contains the data 
    *         that other held previously
    */
    ...
    * pre     if MathVector has size 0, begin/end will be nullptr and 
